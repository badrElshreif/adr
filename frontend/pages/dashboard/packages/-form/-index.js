    ...
    return {
      form: {
        ...
        settings : [
          ...
          body: '',
          text: this.$t('admin.Number_of_added_employees_at_this_package'),
          type: 'number'
        },
        {
          key : 'office_number',
          body: '',
          text: this.$t('admin.Number_of_added_office_at_this_package'),
          type: 'number'
        },
        {
          key : 'admins_number',
          body: '',
          text: this.$t('admin.Number_of_added_admins_at_this_package'),
          type: 'number'
        },
        {
          key : 'hosts_in_every_office',
          body: '',
          text: this.$t('admin.Number_of_added_hosts_in_every_office_at_this_package'),
          type: 'number'
        },
         {
          key : 'access_employee_attendance_report',
          body: '',
          text: this.$t('admin.Get_access_to_every_employee_to_view_his_attendance_report_at_this_package'),
          type: 'checkbox'
        }, {
          key : 'notes_number',
          body: '',
