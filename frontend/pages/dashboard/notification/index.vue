<template>
  <div class="card_db_wrapper">
    <DeleteModal
      ...
      @confirm="trashConfirm('event-delete-brand')"
      @cancel="trashCancel"
    />
    ...
    <div class="countries">
      <div class="level">
        ...
        <div class="level-left">
          <nuxt-link
            :to="localePath('dashboard-notification-create')"
            class="btn btn-success"
            v-show="permissions.includes('notifications.create')"
          >
      ...
      <div class="table_wrap">
        ...
        >
          ...
          <template v-slot:cell(action)="el">
            ...
            <!--<nuxt-link class="table_icon" :to="localePath(`/dashboard/brands/${el.item.id}/edit`)"-->
            ...
            <span
              ...
              v-show="permissions.includes('notifications.delete')"
