    ...
    <div class="wrapper">
      ...
      <nav id="sidebar" :class="['sidebar', { active: isSidebarActive }]">
        ...
        <ul class="mt-4">
          ...
          <li>
            <nuxt-link :to="localePath(`/company-dashboard/employee-rooms`)" >
          ...
          <li>
            <nuxt-link :to="localePath(`/company-dashboard/employee-rooms/chat-room`)">
              <svg class="icon icon_strok">
                <use xlink:href="~/static/svg/sprite.svg/#mm1"></use>
              </svg>
              المحادثات
              </nuxt-link
            >
          ...
          <li>
            <nuxt-link :to="localePath(`/company-dashboard/employee-rooms/library`)">
              <svg class="icon icon_strok">
          ...
          <li>
            <a  role="button" v-b-modal.Settings>
              <svg class="icon icon_strok">
                <use xlink:href="~/static/svg/sprite.svg/#mm2"></use>
              </svg>
              الأعدادات
              </a
            >
...
import SettingsModal from "~/components/company/Modals/SettingsModal.vue";
...
#sidebar ul li:hover a ,#sidebar ul li:hover .btn{
  color: #DF3C14;
}
