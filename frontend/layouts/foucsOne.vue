  ...
  <main :dir="this.$i18n.locale == 'en' ? 'ltr' : 'rtl'">
    <div class="wrapper">
      ...
      <nav id="sidebar" :class="['sidebar', { active: isSidebarActive }]">
        ...
        <ul class="mt-4">
          <li>
            <nuxt-link :to="localePath(`/foucs-dashboard`)" class="active">
              <svg class="icon">
                <use xlink:href="~/static/svg/sprite.svg/#s1"></use>
              </svg>
              غرفة التركيز الخاصة بي</nuxt-link
            >
          </li>

          <li>
            <nuxt-link :to="localePath(`/foucs-dashboard/society`)" class="">
              <svg class="icon">
                <use xlink:href="~/static/svg/sprite.svg/#s2"></use>
              </svg>
              المجتمعات</nuxt-link
            >
          </li>
          <li>
            <nuxt-link :to="localePath(`/foucs-dashboard/packeges`)" class="">
